...
(function () {
    ...
    function renderPanel() {
        ...
        const headerHTML = `
            <div data-handle="drag" style="cursor: move; font-weight: bold; user-select: none; position: relative; background: #ec5353; padding: 0 4px 0 8px;; margin: -5px -5px 8px -5px; border-bottom: 1px solid #444; display: flex; align-items: center; justify-content: space-between; height: 25px;">
